...
Public Class Form1
    ...
    Private Sub Form1_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        numPort.Value = My.Settings.Port
        txtServername.Text = My.Settings.ServerName
        cmbMode.SelectedIndex = My.Settings.GameMode
        cmbLevel.SelectedIndex = My.Settings.Level
        txtLevel.Text = My.Settings.strLevel
        If My.Settings.Level = 16 Then
            txtLevel.Enabled = True
        End If
        txtInterChat.Text = My.Settings.InterChat
        numInterChat.Value = My.Settings.InterChatTime
        txtAdminPass.Text = My.Settings.AdminPass
        CheckBox1.Checked = My.Settings.ShowPass
        chkInfiniteAmmo.Checked = My.Settings.InfiniteAmmo
        txtClientPass.Text = My.Settings.ClientPass
        chkAllowHealth.Checked = My.Settings.AllowHealth
        chkAllowArmor.Checked = My.Settings.AllowArmor
        chkAllowPause.Checked = My.Settings.AllowPause
        numPlayers.Value = My.Settings.MaxPlayers
        chkSpawnInvul.Checked = My.Settings.SpawnInvul
        chkHealthStays.Checked = My.Settings.HealthStays
        chkArmorStays.Checked = My.Settings.ArmorStays
        chkAmmoStays.Checked = My.Settings.AmmoStays
        chkWeaponsStay.Checked = My.Settings.WeaponsStay
        chkExtraEnemies.Checked = My.Settings.ExtraEnemies
        chkFriendlyFire.Checked = My.Settings.FriendlyFire
        chkRespawnInPlace.Checked = My.Settings.RespawnInPlace
        cmbDifficulty.SelectedIndex = My.Settings.Difficulty
        numExtraEnemyStrength.Value = My.Settings.ExtraEnemyStrength
        numExtraEnemyStrengthPerPlayer.Value = My.Settings.ExtraEnemyStrengthPerPlayer
        lblVal1.Text = My.Settings.ExtraEnemyStrength & "%"
        lblVal2.Text = My.Settings.ExtraEnemyStrengthPerPlayer & "%"
        chkCheats.Checked = My.Settings.Cheats
        numFragLimit.Value = My.Settings.FragLimit
        numTimeLimit.Value = My.Settings.TimeLimit
        numFPS.Value = My.Settings.FPS
        numMaxClientBPS.Value = My.Settings.MaxClientBPS
        chkDisableVoting.Checked = My.Settings.DisableVoting

        Me.Left = My.Settings.WindowX
        Me.Top = My.Settings.WindowY
    ...
    Sub Save()
        ...
        My.Settings.Level = cmbLevel.SelectedIndex
        My.Settings.strLevel = txtLevel.Text
        My.Settings.InterChat = txtInterChat.Text
        My.Settings.InterChatTime = numInterChat.Value
        My.Settings.AdminPass = txtAdminPass.Text
        My.Settings.ShowPass = CheckBox1.Checked
        My.Settings.InfiniteAmmo = chkInfiniteAmmo.Checked
        My.Settings.GameMode = cmbMode.SelectedIndex
        My.Settings.ClientPass = txtClientPass.Text
        My.Settings.AllowHealth = chkAllowHealth.Checked
        My.Settings.AllowArmor = chkAllowArmor.Checked
        My.Settings.AllowPause = chkAllowPause.Checked
        My.Settings.MaxPlayers = numPlayers.Value
        My.Settings.SpawnInvul = chkSpawnInvul.Checked
        My.Settings.HealthStays = chkHealthStays.Checked
        My.Settings.ArmorStays = chkArmorStays.Checked
        My.Settings.AmmoStays = chkAmmoStays.Checked
        My.Settings.WeaponsStay = chkWeaponsStay.Checked
        My.Settings.ExtraEnemies = chkExtraEnemies.Checked
        My.Settings.FriendlyFire = chkFriendlyFire.Checked
        My.Settings.RespawnInPlace = chkRespawnInPlace.Checked
        My.Settings.Difficulty = cmbDifficulty.SelectedIndex
        My.Settings.ExtraEnemyStrength = numExtraEnemyStrength.Value
        My.Settings.ExtraEnemyStrengthPerPlayer = numExtraEnemyStrengthPerPlayer.Value
        My.Settings.Cheats = chkCheats.Checked
        My.Settings.FragLimit = numFragLimit.Value
        My.Settings.TimeLimit = numTimeLimit.Value
        My.Settings.FPS = numFPS.Value
        My.Settings.MaxClientBPS = numMaxClientBPS.Value
        My.Settings.DisableVoting = chkDisableVoting.Checked

        My.Settings.WindowX = Me.Left
        My.Settings.WindowY = Me.Top
    ...
    Private Sub Button10_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button10.Click
        System.Diagnostics.Process.Start("http://forums.seriouszone.com/showthread.php?59809-Dedicated-Server-Runner-%28Server-GUI-HD%29")
    End Sub
